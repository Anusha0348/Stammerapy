...
<body id="top">
  ...
  <div class="container contact__container">
    <aside class="contact__aside">
      ...
      <p>Contact us today at Stammerapy for personalized stuttering support and therapy solutions.</p>
      <ul class="contact__details">
        <li>
          <ion-icon name="call-outline"></ion-icon>
          <h5>+92 331 8457893</h5>
        </li>
        <li>
          <ion-icon name="mail-outline"></ion-icon>
          <h5>stammerapy@mail.com</h5>
        </li>
        <li>
      ...
      <ul class="contact__socials">
        <li>
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer"><ion-icon name="logo-facebook"></ion-icon></a>
        </li>
        <li>
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer"><ion-icon name="logo-instagram"></ion-icon></a>
        </li>
        <li>
          <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer"><ion-icon name="logo-linkedin"></ion-icon></a>
        </li>
      </ul>
    </aside>
    ...
    <form action="" method="POST" class="contact__form">
      ...
      <div class="form__name">
        <textarea name="msg" rows="7" placeholder="Message" required></textarea>
      </div>
...
<script>
    ...
    // Validate Name: At least 4 alphabetic characters (ignoring spaces)
    var name = document.getElementById("name").value;
    var namePattern = /^[A-Za-z]{4,}$/;
    if (!namePattern.test(name)) {
      alert("Name should be at least 4 alphabetic characters long.");
      return false;
    }
    ...
    if (!emailPattern.test(email)) {
      alert("Please enter a valid email address. It should contain '@' and end with a valid domain (e.g., .com).");
      return false;
    }
    ...
    if (wordCount < 4) {
      alert("Message should contain at least 4 words.");
      return false;
    }
