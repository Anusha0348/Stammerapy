...
<body id="top">
  ...
  <main>
    ...
    <div class="container">
        ...
        <h2 class="h2 section-title underline">Exercise Videos</h2>

        <div class="service-list">

        <?php
// Adjust the SQL query to fetch active exercise videos
$select_content = $conn->prepare("SELECT * FROM `exercise` WHERE `status` = 'active'");
...
?>
        <div class="service-card">
            ...
            <a href="watchexercise.php?get_id=<?= $fetch_content['id']; ?>" class="btn card-btn">Watch Video</a>
        </div>
