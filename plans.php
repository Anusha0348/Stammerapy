    ...
    <div class="container">
        ...
        ?>
            <div class="service-card">
                ...
                <h3 class="h3 title"><?= $fetch_course['title']; ?></h3>
                <p class="text"><?= $fetch_course['description']; ?></p>

                <a href="plansplaylist.php?get_id=<?= $course_id; ?>" class="btn card-btn">View Plan</a>
            </div>
