...
<section class="playlist-form">
   ...
   <h1 class="heading">update plans</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>plan description <span>*</span></p>
      ...
      <p>plan thumbnail <span>*</span></p>
      <div class="thumb">
         <img src="../uploaded_files/<?= $fetch_playlist['thumb']; ?>" alt="">
      </div>
      <input type="file" name="image" accept="image/*" class="box">
      <input type="submit" value="update plan" name="submit" class="btn">
      <div class="flex-btn">
         <input type="submit" value="delete" class="delete-btn" onclick="return confirm('delete this plan?');" name="delete">
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">view plan</a>
      </div>
   </form>
   <?php
      } 
