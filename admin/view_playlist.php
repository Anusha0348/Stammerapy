...
<section class="playlist-details">
   ...
   <h1 class="heading">plan details</h1>
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">update plan</a>
            <input type="submit" value="delete plan" class="delete-btn" onclick="return confirm('delete this plant?');" name="delete">
         </form>
      </div>
   </div>
   <?php
         ...
         echo '<p class="empty">no plan found!</p>';
      }
   ?>
...
<section class="contents">
   ...
   <h1 class="heading">plan videos</h1>
