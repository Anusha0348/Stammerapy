...
<section class="form-container" style="min-height: calc(100vh - 19rem);">
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            <p>Name</p>
            <input type="text" name="name" placeholder="<?= $fetch_profile['name']; ?>" maxlength="50" readonly class="box">
            <p>Email</p>
            <input type="email" name="email" placeholder="<?= $fetch_profile['email']; ?>" maxlength="20" readonly class="box">
            <p>Update Picture</p>
